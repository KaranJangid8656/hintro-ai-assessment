...
- [x] Public GitHub repository submitted (push after you create the remote)
- [ ] Application deployed and accessible publicly (deploy to Render — see README)
...
- [x] One real third-party integration implemented (Resend)
